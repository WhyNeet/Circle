  ...
  return <main class="flex h-screen w-screen relative">
    <header class="h-[52px] fixed top-0 inset-x-0 flex items-center pl-5 pr-2 justify-between z-50 pointer-events-none">
      <div class="flex items-center gap-4">
        <button class="pointer-events-auto cursor-pointer relative after:-z-10 after:absolute after:-inset-1 after:rounded-md hover:after:bg-base-content/5 text-neutral-600 dark:text-neutral-400 active:after:bg-base-content/10 active:brightness-50 dark:active:brightness-150" onClick={() => setSidebarOpen(prev => !prev)}>
          <PanelRightIcon class="h-5 w-5 rotate-180 stroke-[1.7px]" />
        </button>
