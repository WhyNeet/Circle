...
export default function Layout(props: RouteSectionProps<unknown>) {
  ...
  return <main class="flex bg-base-200 h-screen w-screen relative">
    <header data-tauri-drag-region class="h-[52px] fixed top-0 inset-x-0 flex items-center pl-5 pr-2 justify-between z-40">
      <div class="flex-1 pointer-events-none flex items-center gap-4">
